...
combinatorial optimization problems show that, despite
...
% Ya decía yo que eso que estaba mal escrito no podía haberlo hecho yo... Reescrito - JJ 
...
% reevaluarlos un númereo de veces - corregido - JJ
...
\end{table}
%
ITA and WPO have been tested using two well-known benchmarks, the Trap
function and the MMDP problem \cite{goldberg92massive}. 
...
any case, see the effect of doing it. All these hypothesis will form
