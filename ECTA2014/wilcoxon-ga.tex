...
\affiliation{\sup{1}University of Granada, 
       ...
       18071 - Granada}
\affiliation{\sup{2}S2Grupo}
\affiliation{\sup{3}Universidad de Málaga,
Departamento de Lenguajes y Sistemas Informáticos}
\affiliation{\sup{4}Universidad de Granada; Depto. Estadística e Investigación Operativa}
...
previous research \cite{castilloGECCO99} and leads, if
...
\begin{figure}
\centering
\includegraphics[width=0.4\textwidth]{../images/sd.png}
...
\begin{figure*}[!t]
\centering
\includegraphics[scale=0.8]{../images/indi8.png}
...
chromosome size. We have also used an additive gaussian noise centered in zero
...
\includegraphics[width=0.4\textwidth]{../images/trap-evals-all.png}
}
~
\subfloat[Fitness distribution]{
\includegraphics[width=0.4\textwidth]{../images/trap-noisy-evals.png}
}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.45\textwidth]{../images/evals-mmdp.png}
