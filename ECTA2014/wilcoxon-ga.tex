...
\abstract{In games as in life, the outcome of a match is uncertain due
  to several reasons: the characters appear in different initial
  conditions or the response of the player, even if programmed, is not
  deterministic; different matches will get different score. That is a
  problem when optimizing a game-playing engine: fitness will be
