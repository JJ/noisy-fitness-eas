...
Universidad de Granada; Depto. Estadística e Investigación Operativa, Granada, Spain
\email{\{jmerelo,pedro,amorag,antares\}@geneura.ugr.es,aiesparcia@s2grupo.es,\\
...
% Zeineb - If we look at it in a more general setting, ... ("it" not "in")
...
% [...] actually included in [...] || [...] in one (or in | of) the four [...]
...
% This line works fine without 'which' because it is already implied.
of this work. 
...
% I would personally use 'structured as follows', but it is up to you. And probably after the colon you
% should start with 'in the next chapter/section [...]' just to clarify.
...
explained next.
% Zeineb - In this situation, several solutions have been proposed ... ("have" not "were")
...
%to use whatever value is returned a single time or after a re-evaluation of each generation.
...
% Zeineb - Besides, most models keep the number of evaluations   fixed and independent of its value, 
