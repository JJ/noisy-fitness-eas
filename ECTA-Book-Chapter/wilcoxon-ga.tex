...
Departamento de Lenguajes y Sistemas Inform\'aticos, M\'alaga, Spain\\
...
was done by Jin and Branke in 2005 \cite{Jin2005303}, although recent
...
In the same situation, a noisy fitness evaluation, several solutions have been
...
previous research in games and evolution of neural networks \cite{castilloGECCO99,bots:evostar,merelo:ESNN,DBLP:journals/jcst/MoraFGGF12,Liberatore_COSECIVI14} and leads, if
...
evolutionary algorithm based on mutation (such as the $\mu$+1 EA)
...
this game when one player {\em invades} a planet the outcome depends
...
map is also random, chosen from 100 posibilities. Besides, in
...
averages of fitness appropriate for modelling the whole set of fitness
...
noise to simulate it; Gaussian is a good aproximation of Gamma for
